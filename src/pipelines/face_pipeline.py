...
def get_face_embeddings(image_np):
    ...
    # Implementation for getting face embeddings
...
def get_trained_model():
    ...
    clf=CalibratedClassifierCV(SVC(kernel='linear', class_weight='balanced'), ensemble=False)
